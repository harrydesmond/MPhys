#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed 15 Oct 10:05:24 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 40 --mpi=pmix --mem-per-cpu=40960 nice -n 10 /mnt/users/darnej/MPhys/TNG-50/./job.sh 
  echo ---------------                                           
