...
df.to_csv('/mnt/users/darnej/MPhys/v_rot_over_sigma.csv')
...
for gal in chunks:
    ...
    bincenters, mean_acc_obs, mean_acc_bar, total_mean_acc_bar, v_obs, v_bar, v_tot, V_C, V_C_spline, sigma_v, gas_positions, H1_densities, rotated_points = V_plot(int(gal), ozy_file, sim = 'NH',)
    ...
    v_obs = v_obs/1000 #to get into km/s
...
if rank == 0:
    ...
    df.to_csv('/mnt/users/darnej/MPhys/v_rot_over_sigma.csv', mode='a', header=False, index=False)
