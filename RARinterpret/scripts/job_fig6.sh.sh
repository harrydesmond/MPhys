#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed 22 Apr 16:59:38 BST 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 64 --mpi=pmix --mem-per-cpu=40960 nice -n 10 /mnt/users/darnej/MPhys/RARinterpret/scripts/./job_fig6.sh 
  echo ---------------                                           
